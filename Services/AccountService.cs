namespace WebAngkorLar.Services;
...
public class AccountService : IAccountService
{
    ...
    public AuthenticateResponse Authenticate(AuthenticateRequest model, string ipAddress)
    {
        ...
        account.RefreshTokens.ToList().Add(refreshToken);
    ...
    public AuthenticateResponse RefreshToken(string token, string ipAddress)
    {
        ...
        var refreshToken = account.RefreshTokens.ToList().Single(x => x.Token == token);
        ...
        account.RefreshTokens.ToList().Add(newRefreshToken);
    ...
    {
        var account = _context.Accounts
            .Include(p => p.RefreshTokens.Where(e => e.Token == token))
            .SingleOrDefault();
    ...
    private void revokeDescendantRefreshTokens(RefreshToken refreshToken, Account account, string ipAddress, string reason)
    {
        ...
        {
            var childToken = account.RefreshTokens.ToList().SingleOrDefault(x => x.Token == refreshToken.ReplacedByToken);
